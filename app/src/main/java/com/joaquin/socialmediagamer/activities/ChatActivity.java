...
import com.joaquin.socialmediagamer.adapters.MessageAdapter;
...
import com.joaquin.socialmediagamer.providers.MessageProvider;
...
public class ChatActivity extends AppCompatActivity {
                ...
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("online")) {
                        ...
                        if (online) {
                            ...
                            if (documentSnapshot.contains("lastConnect")) {
    ...
    private void updateViewed() {
        ...
        mMessageProvider.getMessageByChatAndSender(mExtraIdChat, idSender).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                for (DocumentSnapshot document : queryDocumentSnapshots.getDocuments()) { //Recorremos los docuemntos que fueron encontrados en la consulta
