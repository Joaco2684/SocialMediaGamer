...
public class ChatsAdapter extends FirestoreRecyclerAdapter<Chat, ChatsAdapter.ViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull Chat chat) {
        ...
        final String chatId = document.getId(); //Persona con la que estamos chateando
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView textViewMessageNotRead;
        ...
        public ViewHolder(View view) {
            ...
            frameLayoutMessageNotRead = view.findViewById(R.id.frameLayoutMessageNotReads);
            viewHolder = view;
        }
    }
