...
public class ChatsProvider {
    ...
    public Query getAll(String idUser) {
        return mCollection.whereArrayContains("ids", idUser); //Si existe algún docuemnto que contenga dentro del  array el IdUser
    }
    ...
    public Query getChatByUser1AndUser2(String idUser1, String idUser2) {
        ...
        return mCollection.whereIn("id", ids); //Averiguar si hay una combinación de estas en la base de datos
    }
